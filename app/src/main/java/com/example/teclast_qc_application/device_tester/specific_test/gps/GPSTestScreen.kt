package com.example.teclast_qc_application.device_tester.specific_test.gps
...
@Composable
fun GPSTestScreen(context: Context, navController: NavController, ) {
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Button(onClick = {
                    navController.navigate("gps_test_t1_screen"){
