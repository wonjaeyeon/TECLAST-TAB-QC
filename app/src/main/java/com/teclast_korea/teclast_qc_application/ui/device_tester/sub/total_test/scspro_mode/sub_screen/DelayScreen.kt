package com.teclast_korea.teclast_qc_application.ui.device_tester.sub.total_test.scspro_mode.sub_screen
...
@Composable
fun SCSPROModeTestScreenScaffold(
    navController: NavHostController,
    nextTestRoute: MutableList<String>,
    progress: Float,
    done: List<String>,
    undone: List<String>,
    titleText: String = "SCSPRO Mode Test",
