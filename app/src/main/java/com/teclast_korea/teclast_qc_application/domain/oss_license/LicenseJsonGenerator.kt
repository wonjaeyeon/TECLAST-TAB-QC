package com.teclast_korea.teclast_qc_application.domain.oss_license
...
//    }
    ...
    private fun parseLicenseMetadata(): List<OSSLicenseInfo> {
        ...
        val licenseInfos = mutableListOf<OSSLicenseInfo>()
    ...
    fun getLicenseInfo(index: Int, libraryName: String): OSSLicenseInfo {
